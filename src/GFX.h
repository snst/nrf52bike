...
class GFX : public Stream {
 ...
 public:
  ...
  uint16_t drawCharLine(uint16_t* ptr, GFXglyph *glyph, uint8_t y, uint16_t font_height);
  void write_chars(uint16_t x, uint16_t y, uint16_t w, const char* chars, uint16_t len);
